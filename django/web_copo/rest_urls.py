...
urlpatterns = patterns('',
    ...
    url(r'^ena_study_form_attr/', rest_views.get_ena_study_attr, name='get_ena_study_attr'),
    url(r'^ena_new_study/', rest_views.save_ena_study_callback, name='save_ena_study'),
    url(r'^ena_new_sample/', rest_views.save_ena_sample_callback, name='save_ena_sample'),
)